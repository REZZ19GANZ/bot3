    ...
    try {
        if (m.mentionedJid.includes(this.user.jid) && m.isGroup) {
            await this.send2Button(m.chat,
                isBanned ? 'Mel-Bot NEXT PROJECT NOT ACTIVE' : banned ? 'TELAH DI BANNED' : 'Mel-Bot NEXT PROJECT IN HERE',
                '©Mel-Bot',
...
30 Hari / Rp 15.000
└────
https://youtube.com/c/Mel-Bot7
Subscribe Me To Get Trial 1 Days

`.trim(), '©Mel-Bot', 'CHAT ME TO BUY', ',owner', { contextInfo: { mentionedJid: [global.owner[0] + '@s.whatsapp.net'] } })
    }
...
Mel-Bot NEXT PROJECT`).catch(_ => _)
